...
var iconmappr = {
    ...
    4 : '<div id="XXX" class="col play-col"><img class="jewel" src="/TrabalhoFinal/imgs/css.png" alt=""></div>',
    5 : '<div id="XXX" class="col play-col"><img class="jewel" src="/TrabalhoFinal/imgs/js.png" alt=""></div>',
}
